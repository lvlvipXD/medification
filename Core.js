...
case 'هل':
    ...
    if (isBanChat) return reply(mess.bangc)
					...
					const Akashitttt =['شدراني انا','معرفش','تقصد نفسك','لا','حصل','نعم','صح','شدخلني','دز','اتفق الف','حصل','العالم كلو متفق معك','انا معك ف دي','ياخي صدعتني','انقلع','ادا انتا بتشوف كدا ف يب','يعني ممكن نقول ايوا صح','الصراحة معك حق','انتا ادرى في الامور دي','ترااك مزعج','روح اسأل غيري بالله','الي تقوله انت صح','صح و خلينا نرتاح شوي يا حب','محصلش','دا عمك','ادلف انتا و هو','ياخي خلاص هل هل هل روح نام','صادق','ايوة بالضبط كدا','يبب']
...
case 'شخصيتك':
    ...
    if (isBanChat) return reply(mess.bangc)
					...
					Akashi.sendMessage(from, { text: `⌛ جاري تحليل شخصية \n\n [■■■■■■■■■□] 90% : ${q}\n\nالجواب : *${takyzq}*` }, { quoted: m })  
	                              break
...
•∆-انطق_انجليزي
•∆-انطق_هندي
•∆البوت ينطق اي شي تكتبه (بعد الامر)
